          ...
          <div className="mt-8 animate-fade-in">
            ...
            <div className="flex justify-center gap-6 mt-8">
              <Button
                ...
                onClick={() => window.open('https://www.linkedin.com/in/qadri-syed', '_blank')}
              >
              ...
              <Button
                ...
                size="lg"
                className="hero-social-button"
                onClick={() => window.open('https://drive.google.com/file/d/1JsW_mpFO5zPLGBKX7rBcQMctHq1nqNja/view?usp=sharing', '_blank')}
              >
